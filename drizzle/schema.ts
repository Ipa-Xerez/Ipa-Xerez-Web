...
export const blogPosts = mysqlTable("blog_posts", {
  ...
  image: text("image"), // URL to featured/cover image
  category: varchar("category", { length: 100 }),
  tags: text("tags"), // JSON array of tags
  isPublished: tinyint("isPublished").default(1).notNull(),
  featured: tinyint("featured").default(0).notNull(), // Show on homepage
  featuredOrder: int("featuredOrder").default(0).notNull(), // Order on homepage (ASC)
